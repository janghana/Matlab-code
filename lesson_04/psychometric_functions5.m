...
dots2.speed = 5;
dots2.lifetime = 12;
dots2.apertureSize = [12,12];
dots2.center = [0,0];
dots2.color = [255,255,255];
dots2.size = 8;
dots2.coherence = design.startingCoherence;       %coherence  level for the first trial
...
try
    ...
    drawText(display,[0,6],'Press "1" for 1 and "2" for 2',[255,255,255]);
    ...
    for trialNum = 1:design.nTrials
        ...
        dots2.direction = design.directions(trialNum);
        
        tmp = ceil(rand(1,design.nTrials)+.5);
        ...
        if tmp == 1
            ...
            pause(1);
            dots2.speed = 10;
            movingDots(display,dots2,design.stimDur);
        end
        if tmp == 2
            dots2.speed = 10;
            movingDots(display,dots2,design.stimDur);
        ...
        results.intensity(trialNum) = dots2.coherence;
